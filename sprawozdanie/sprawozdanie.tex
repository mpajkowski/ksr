...
\section{Cel}
Celem zadania było zaprojektowanie i stworzenie programu komputerowego, którego zadaniem
jest klasyfikacja obiektów z wykorzystaniem technik takich jak ekstrakcja cech oraz algorytmu
